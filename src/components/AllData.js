...
import CleaningOil1 from "../img/products/skincareA.webp";
import CleaningOil2 from "../img/products/skincareA1.webp";
...
import BodyOil1 from "../img/products/skincareA.webp";
import BodyOil2 from "../img/products/skincareA1.webp";
import BodyOil3 from "../img/products/skincareA2.webp";
...
import Cotton1 from "../img/products/skincare.webp";
import Cotton2 from "../img/products/skincare2.webp";
...
import Iphoneblack from "../img/products/iphoneblack.webp";
import Iphoneblue from "../img/products/iphoneelectronic.webp";
import Iphonegreen from "../img/products/iphonegreen.webp";
...
export const items = [
  {
    ...
    category: "chair",
    img: Img1,
    description: "Little chair",
    price: 2000,
    otherImgs: [OtherImgs1, OtherImgs2],
    specs:
      "Traditional Little  Armchair Sheepskin and this Armchair is long lasting and more comfortable for sitting ",
    texture: "Sheep Skin",
    weight: "15kg",
    size: "150cm x 70cm",
  },
  ...
  },
  {
    ...
    specs:
      "The Verner Panton Flowerpot , designed in 1901, was originally intended for the restaurant industry and Verner Panton exhibitions.",
    texture: "Plastic",
    weight: "2kg",
    size: "15cm x 15cm",
  },
  {
    ...
    specs:
      "Pulp Units are lightweight and long lasting, and can be used horizontally or vertically. Designed with A4 paper in mind .",
    texture: "Wood",
    weight: "45kg",
    size: "250cm x 60cm",
  },
  {
    ...
    specs:
      "havells  have created an incredibly beautiful pendant, in a completely unique design. The lamp is made using a special metallization technology that makes the look completely unique. The first of its kind. the lamp is transparent when its on and you can see the exciting play of colors.",
    texture: "Plastic",
    weight: "3kg",
    size: "20cm x 20cm",
  },
  ...
  },
  {
    ...
    specs:
      "Concept: Havells is inspired by perforated metal and the patterns that light creates when it shines through the small holes. The contrast between the coarse perforated metal and the smooth opal glass makes the Dot a simple and meaningful pendant. With its elegant expression, Shine, whether the light is on or off.",
    texture: "Plastic",
    weight: "6kg",
    size: "20cm x 20cm",
  },
  {
    ...
    category: "furniture",
    img: Img8,
    description: "Black Furniture",
    price: 1200,
    otherImgs: [Shelf1, Shelf2],
    specs:
      "Designed by Samrat & Ashok, This is a minimalist wall shelf designed with functionality and aesthetics in mind. Without unnecessary details and clean lines, this collection hangs easily and elegantly on the wall, creating calm and an overview of the things you want to put on the shelf.",
    texture: "Wood",
    weight: "10kg",
    size: "60cm x 20cm",
  },
  ...
  },
  {
    ...
    specs:
      "Concept: &Tradition's  Armchair is a classic Indian design with a modern and minimalist expression. The chair was designed by Chetan & Vaibhav in 1956, and with its stylish cushions and hand-polished wooden frame, it is an ideal Nordic design that gives a personal mark to the home.",
    texture: "Wood",
    weight: "8kg",
    size: "60cm x 40cm",
  },
  {
    ...
    specs:
      "The Here Comes The Sun pendant designed by Surendar Sharma is a quality lamp with a unique and magical look. The Here Comes The Sun series has a fantastic expression and especially swhen turned on it creates a very special atmosphere in the room it hangs in. The lamp fits perfectly above both dining room table, kitchen counter, and as living room lighting . ",
    texture: "Plastic",
    weight: "4kg",
    size: "20cm x 20cm",
  },
  {
    ...
    specs:
      "Vernon Flowerpot, designed in 1950, was originally meant for the hospitality industry and Varun Aron displays and showrooms. The lamp then became popular in private homes, and due to its stylish design and many colour choices, it has made a major comeback in recent years.",
    texture: "Plastic",
    weight: "4kg",
    size: "15cm x 15cm",
  },
  {
    ...
    category: "skin-care",
    img: Cotton1,
    description: "Anti Acne Oil 50ml",
    price: 399,
    otherImgs: [Cotton1, Cotton2],
    specs:
      "Cotton pads made from soft, unbleached cotton. These are made in India and made from 100% cotton.",
    texture: "Cotton",
    weight: "180g",
    size: "20cm x 10cm",
  },
  {
    ...
    specs:
      "When talking about Oak Spanish Chair, The Spanish Chair is probably one of the first designs you would think of, which makes good sense as it is also one of his most recognized products around the world.",
    texture: "Wood",
    weight: "15kg",
    size: "60cm x 30cm",
  },
  {
    ...
    category: "chair",
    img: Img15,
    description: "Cooper Armchair",
    price: 3000,
    otherImgs: [Copenhagen1, Copenhagen2],
    specs:
      "Concept: The Hyg series by Dravid Cooper is a series of chairs based on the Danish word Hygge. The designer Siddhu singh has tried to embody the meaning of the word around security, warmth and convenience in a furniture series. This is expression in the fine organic shapes and hearty curves that provide a high degree of sitting comfort and well-being in the chairs. ",
    texture: "Wood",
    weight: "14kg",
    size: "65cm x 35cm",
  },
  ...
  },
  {
    ...
    specs:
      "Sum is a series designed by the Ravi designer  who is the epitome of modern elegance. Elegant and resolute as the tip of a wing, the armrests spread out invitingly, as if they want to embrace you in the armchair's soft, homely space.",
  ...
  },
  {
    ...
    category: "skin-care",
    img: BodyOil1,
    description: "Anti Acne Gel 30ml",
    price: 450,
    otherImgs: [BodyOil1, BodyOil2,BodyOil3],
    specs:
      "Made In India , Made for the World, Made from 100% plant-based oils with olive oil as the main ingredient, this cleansing oil is gentle on the skin. Free from fragrance, colours and, mineral oils, paraben free, alcohol free, allergy tested (we cannot guarantee that it will not cause allergies in any users) * How to use: Take a small amount in the palm of your hand, and massage into the face to remove make-up and dirt. Rinse well with cold or warm water.",
    texture: "Liquid",
    weight: "50ml",
    size: "10cm x 5cm",
  },
  {
    ...
    price: 75000,
    otherImgs: [Iphoneblack, Iphoneblue,Iphonegreen],
    specs: "Long Lasting, High Quality Camera, Super Display Quality ",
    texture:"plastic",
    weight: "500g",
    size: "5cm x 10cm",
  }
